...
//        String red = splitted[4];
//        String blue = splitted[5];
        String total = splitted[6];
        
        int finalScore = Integer.parseInt(total);
        
        System.out.println(user1 + " co: " + total + " diem");
...
//        newAvgCompetitor2 = Math.round(newAvgCompetitor2 * 100) / 100;
    ...
    public void client1Win(int time) throws SQLException {
        ...
        user1.setScore(user1.getScore()+ 1.0f);
