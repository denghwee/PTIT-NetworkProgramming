...
public class SocketHandler {
            ...
            try {
                ...
                switch (type) {
                    ...
                    case "UPDATE_USER_SCORE":
                        onReceiveUpdateUserScore(received);
                        break;
                    case "LOGOUT":
    ...
    public void updateUserScore(String username) {
        sendData("UPDATE_USER_SCORE;" + username);
    }
    ...
    public void submitResult (String competitor) { 
        int redScore = ClientRun.gameView.getRedScore();
        int blueScore = ClientRun.gameView.getBlueScore();
        ...
        String data = String.valueOf(redScore) + ";" + String.valueOf(blueScore) + ";" + String.valueOf(totalScore) + ";" + time;
    ...
    private void onReceiveUpdateUserScore(String received) {
        // get status from data
        String [] splitted = received.split(";");
        String status = splitted[1];
        
        if (status.equals("success")) {
            float userScore = Float.parseFloat(splitted[2]);
